...
import { sampleWithRequiredData, sampleWithNewData, sampleWithPartialData, sampleWithFullData } from '../drink.test-samples';

import { DrinkService } from './drink.service';

const requireRestSample: IDrink = {
...
describe('Drink Service', () => {
  ...
  describe('Service methods', () => {
    ...
    it('should create a Drink', () => {
      const drink = { ...sampleWithNewData };
      const returnedFromService = { ...requireRestSample };
      const expected = { ...sampleWithRequiredData };

      service.create(drink).subscribe(resp => (expectedResult = resp.body));
    ...
    it('should update a Drink', () => {
      const drink = { ...sampleWithRequiredData };
      const returnedFromService = { ...requireRestSample };
      const expected = { ...sampleWithRequiredData };

      service.update(drink).subscribe(resp => (expectedResult = resp.body));
    ...
    describe('addDrinkToCollectionIfMissing', () => {
      it('should add a Drink to an empty array', () => {
        const drink: IDrink = sampleWithRequiredData;
      ...
      it("should add a Drink to an array that doesn't contain it", () => {
        const drink: IDrink = sampleWithRequiredData;
        const drinkCollection: IDrink[] = [sampleWithPartialData];
        expectedResult = service.addDrinkToCollectionIfMissing(drinkCollection, drink);
        expect(expectedResult).toHaveLength(2);
        expect(expectedResult).toContain(drink);
      });
      ...
      it('should add only unique Drink to an array', () => {
        const drinkArray: IDrink[] = [sampleWithRequiredData, sampleWithPartialData, sampleWithFullData];
        const drinkCollection: IDrink[] = [sampleWithRequiredData];
      ...
      it('should accept varargs', () => {
        const drink: IDrink = sampleWithRequiredData;
        const drink2: IDrink = sampleWithPartialData;
    ...
    describe('compareDrink', () => {
      it('Should return true if both entities are null', () => {
        const entity1 = null;
        const entity2 = null;

        const compareResult = service.compareDrink(entity1, entity2);
      ...
      it('Should return false if one entity is null', () => {
        ...
        const compareResult1 = service.compareDrink(entity1, entity2);
        const compareResult2 = service.compareDrink(entity2, entity1);
