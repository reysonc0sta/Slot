...
import { EntityArrayResponseType, DrinkService } from '../service/drink.service';
...
export class DrinkComponent implements OnInit {
  ...
  trackId = (_index: number, item: IDrink): number => this.drinkService.getDrinkIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.drinks = dataFromBody;
  }

  protected fillComponentAttributesFromResponseBody(data: IDrink[] | null): IDrink[] {
    return data ?? [];
  }
  ...
  protected queryBackend(): Observable<EntityArrayResponseType> {
    ...
    return this.drinkService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
