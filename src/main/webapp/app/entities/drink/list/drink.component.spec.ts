...
import { sampleWithRequiredData } from '../drink.test-samples';
...
describe('Drink Management Component', () => {
  ...
  describe('trackId', () => {
    it('Should forward to drinkService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getDrinkIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getDrinkIdentifier).toHaveBeenCalledWith(entity);
